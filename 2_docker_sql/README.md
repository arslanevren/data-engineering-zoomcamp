...
sudo docker run -it \
    ...
    -e POSTGRES_PASSWORD="root" \
    -e POSTGRES_DB="ny_taxi" \
    -v /home/earslan/data-engineering-zoomcamp/2_docker_sql/ny_taxi_postgres_data:/var/lib/postgresql/data \
    -p 5433:5432 \
    --network pg-network \
    --name pg-database \
    postgres:13
...
URL="http://127.0.0.1:8888/lab/tree/2_docker_sql/yellow_tripdata_2021-01.csv"
docker run -it \
  --network=pg-network \
  taxi_ingest:v001 \
    --user=root \
